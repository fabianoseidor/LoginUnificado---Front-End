...
<html lang="en">
	...
	<body>
		...
		<form action="ServletTrocaSenha" method="post" id="formTrocaSenha" class="row g-3 needs-validation" novalidate>
    		...
    		<!--  
    		 <a class="btn btn-outline-secondary btn-sm" href="<%= request.getContextPath() %>/ServletTrocaSenha" role="button">Alterar Senha</a>
            -->
